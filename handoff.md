...
- WeChat local companion Task 5 on 2026-05-26: documentation and release packaging were aligned for the mobile companion V1, including required release suffixes, USER_GUIDE/WEB_GUIDE scope notes, and stable implementation memory. Focused verification: `C:\Users\22676\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe -m unittest tests.test_mobile_responses tests.test_mobile_app tests.test_miniprogram_assets tests.test_release_package -v`.
