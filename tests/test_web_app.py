...
class WebAppTests(unittest.TestCase):
    ...
    def test_frontend_assets_include_literature_insight_renderer(self) -> None:
        ...
        self.assertIn("renderProjectFileScan", renderers_js)
        self.assertIn("parseSuggestedPaths", renderers_js)
        self.assertIn("renderWorkflowStatus", renderers_js)
        self.assertIn("parseWorkflowSteps", renderers_js)
        self.assertIn("workflowTargetForStep", renderers_js)
        self.assertIn("workflow-jump-button", renderers_js)
        self.assertIn("renderProjectCheck", renderers_js)
        self.assertIn("parseProjectCheckCards", renderers_js)
        self.assertIn("renderProjectNextActions", renderers_js)
        self.assertIn("project-next-actions-card", css)
        self.assertIn("renderManuscriptCheck", renderers_js)
        self.assertIn("parseManuscriptIssues", renderers_js)
        self.assertIn("renderSimulationReport", renderers_js)
        self.assertIn("parseSimulationReportRows", renderers_js)
        self.assertIn("renderFigureResult", renderers_js)
        self.assertIn("parseGeneratedPaths", renderers_js)
        self.assertIn("renderSavedReportResult", renderers_js)
        self.assertIn("savedReportPurpose", renderers_js)
        self.assertIn("renderNoteResult", renderers_js)
        self.assertIn("noteResultPurpose", renderers_js)
        self.assertIn("renderLibraryResult", renderers_js)
        self.assertIn("parseLibraryEntries", renderers_js)
        self.assertIn("renderLibraryAssetReport", renderers_js)
        self.assertIn("parseInventorySection", renderers_js)
        self.assertIn("renderPlanningReport", renderers_js)
        self.assertIn("planningReportSections", renderers_js)
        self.assertIn("renderProjectReport", renderers_js)
        self.assertIn("parseProjectReportMetrics", renderers_js)
        self.assertIn("renderProjectInitResult", renderers_js)
        self.assertIn("parseCreatedProjectPath", renderers_js)
        self.assertIn("renderResultFallback", renderers_js)
        self.assertIn("resultFallbackAdvice", renderers_js)
        self.assertIn("fallbackTargetForAction", renderers_js)
        self.assertIn("data-target-section", renderers_js)
