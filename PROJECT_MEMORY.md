...
- A local browser UI is available through `start_web.bat`, which runs `workflow.web_app` on `127.0.0.1:8000` for common project and library actions without typing Python commands.
